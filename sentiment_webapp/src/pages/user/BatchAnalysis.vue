...
import { UploadFilled, FolderOpened, Check, Download, Document } from '@element-plus/icons-vue'
import {
...
const navigateToHistoryAfterSubmit = async () => {
  try {
    await router.push('/user/history')
  } catch {
    ElMessage.warning('批量任务已提交，但未能跳转到历史记录，请手动前往查看')
  }
}
